...
class FairseqEncoderDecoderModel(BaseFairseqModel):
    ...
    def forward_decoder(self, ema_model, index, prev_output_tokens, **kwargs):
        if ema_model == 0:
           return self.decoder(index, prev_output_tokens, **kwargs)
        else:
           return self.ema_decoder(index, prev_output_tokens, **kwargs)
